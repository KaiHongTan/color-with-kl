        ...
        {this.props.alldone && (
          ...
          >
            ...
            <div>
              <p />
              <p>
                蛋花在马来婚礼期间用作马来配对的工具，为新婚夫妇献上生育祝福。通常会用一朵花系在一粒鸡蛋上，然后用黄色的糯米裹起来，放在新娘旁的左右侧。
              </p>
              <p>
                蛋花在馬來婚禮期間用作馬來配對的工具，為新婚夫婦獻上生育祝福。通常會用一朵花系在一粒雞蛋上，然後用黃色的糯米裹起來，放在新娘旁的左右側。
              </p>
            </div>
          </ReactTooltip>
        )}
        ...
        {this.props.alldone && (
          ...
          >
            ...
            <div>
              <p />
              <p>
                皮影戏是一种由影子艺术家所呈现的木偶皮影戏。它是使用皮革刻出来的模型，在画面和灯之间反映出会动的影子。是具有仪式，教育和娱乐的皮影戏。
              </p>
              <p>
                皮影戲是一種由影子藝術家所呈現的木偶皮影戲。它是使用皮革刻出來的模型，在畫面和燈之間反映出會動的影子。是具有儀式，教訓和娛樂的皮影戲。
              </p>
            </div>
          </ReactTooltip>
        )}
