...
const Kualalumpur = () => {
  ...
  function changePic(food) {
    if (kltdone === 0 && matradedone === 0 && mitecdone === 0 && ttdone === 0) {
      ...
      (kltdone === 1 && matradedone === 1 && mitecdone === 1 && ttdone === 0) ||
      ...
      <div className="palettes">
        {showklt ? (
          <div
            ...
            draggable="true"
            onDragStart={(event) => dragklt(event)}
        ...
        {showmatrade ? (
          <div
            className="color-swatch"
            draggable="true"
            onDragStart={(event) => dragmatrade(event)}
        ...
        {showmitec ? (
          <div
            className="color-swatch"
            draggable="true"
            onDragStart={(event) => dragmitec(event)}
        ...
        {showtt ? (
          <div
            className="color-swatch"
            draggable="true"
            onDragStart={(event) => dragtt(event)}
